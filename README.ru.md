...
3. При отсутствии файла и `restoreMissingToCache: true` текущий запрос идёт в сеть (отменяемый range), в фоне загружается полный файл в кеш для следующих запросов
